...
export default function CustomerBridge({ compact = false, nexusOverlay = false, mobileCompact = false }) {
  ...
  const NEXUS_SUGGESTIONS_BY_PERSONA = {
    ...
    regional_mgr: [
      ...
      { key: 'close', label: 'Any cash variances from last night?', icon: FileText, gradient: 'from-green-600/20 to-emerald-600/20', border: 'hover:border-green-500/40', tag: 'Close', tagColor: '#00C27C', action: 'close' },
      { key: 'delivery', label: 'What deliveries are coming in today?', icon: Truck, gradient: 'from-blue-600/20 to-cyan-600/20', border: 'hover:border-blue-500/40', tag: 'Receiving', tagColor: '#64A8E0', action: 'delivery' },
    ...
    compliance: [
      ...
      { key: 'discrepancy', label: 'Any inventory counts off that need fixing?', icon: AlertTriangle, gradient: 'from-amber-600/20 to-yellow-600/20', border: 'hover:border-amber-500/40', tag: 'Exceptions', tagColor: '#D4A03A', action: 'discrepancy' },
      { key: 'audit', label: 'Are we ready for the upcoming inspection?', icon: Eye, gradient: 'from-blue-600/20 to-cyan-600/20', border: 'hover:border-blue-500/40', tag: 'Readiness', tagColor: '#64A8E0', action: 'audit' },
      { key: 'regulatory', label: 'What new rules are coming down the pipe?', icon: Clipboard, gradient: 'from-purple-600/20 to-violet-600/20', border: 'hover:border-purple-500/40', tag: 'Upcoming', tagColor: '#B598E8', action: 'regulatory' },
    ],
  };
